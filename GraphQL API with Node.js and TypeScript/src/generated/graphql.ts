...
> = ResolversObject<{
  addBook?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAddBookArgs, 'author' | 'title' | 'year'>
  >;
  addUser?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<MutationAddUserArgs, 'email' | 'name'>
  >;
  deleteBook?: Resolver<
  ...
  updateBook?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateBookArgs, 'id'>
  >;
  updateUser?: Resolver<
...
> = ResolversObject<{
  ...
  searchBooks?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerySearchBooksArgs, 'title'>
  >;
  user?: Resolver<
    Maybe<ResolversTypes['User']>,
    ParentType,
